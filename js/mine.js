...
function displayWeather() {
  let hasala = `<div class="col-4 forcast-bg rounded-start">
    ...
    <div class="col-4 middle-forcast-bg">
          ...
          <div class="col-4 forcast-bg rounded-end">
            <div class="d-flex justify-content-center forcast-header">
  ...
  document.getElementById("forcast-data").innerHTML = hasala;
}
